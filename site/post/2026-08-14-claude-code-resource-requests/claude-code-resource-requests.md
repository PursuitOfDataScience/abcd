...
[figure: The worst case in absolute terms: a job needing 0.40 GiB was reported as 6.95 by Slurm's accounting and 15.07 by the raw control-group counter, the latter above the job's own 8 GiB limit.] Figure 2: The worst case in absolute terms: a job needing 0.40 GiB was reported as 6.95 by Slurm’s accounting and 15.07 by the raw control-group counter, the latter above the job’s own 8 GiB limit.
...
[figure: Behind the top row, 7.84 GiB was reserved for a job that needed 0.05. The six rows meeting the memory target are a single three-GPU workload measured on six occasions.] Figure 3: Behind the top row, 7.84 GiB was reserved for a job that needed 0.05. The six rows meeting the memory target are a single three-GPU workload measured on six occasions.
