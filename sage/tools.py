...
def tool_schemas(profile) -> list[dict]:
    ...
    what the corpus contains before it has searched it. A description belonging to
    some other corpus sends the very first search somewhere this one cannot go.
    """
    return [
        {
            "type": "function",
