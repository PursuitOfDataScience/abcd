...
def parse_scraped(text: str) -> tuple[str, str, str]:
    ...
    per-page citations possible:
        ...
        URL: https://example.org/faqs
        Title: FAQs | Example Docs
        ================================================================
    """
    url = ""
    title = ""
    ...
    for idx, line in enumerate(lines[:6]):
        ...
        if stripped.startswith("URL:"):
            ...
            # Drop the site suffix: "FAQs | Example Docs".
...
def parse_post_header(text: str) -> tuple[str, str, str, str]:
    """Split a synced blog post into (url, title, date, markdown body).
