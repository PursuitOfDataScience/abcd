...
class Document:
    ...
    # Publication date, for sources that have one. The assistant is asked to give
    # it when it matters: a method from a 2021 article is five years old.
    date: str = ""
...
def chunk_post(
    ...
    """
    profile = profile or profiles.active()
    url, title, date, body = parse_post_header(raw)
    document, chunks = chunk_markdown(
